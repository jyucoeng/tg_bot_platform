...
curl -O https://raw.githubusercontent.com/jyucoeng/tg_bot_platform/main/docker-compose.yml
```
...
```yaml
# 使用特定版本
image: ghcr.io/jyucoeng/tg_bot_platform:v2.0.3
...
docker run -d \
  ...
  -v ./data:/app/data \
  ghcr.io/jyucoeng/tg_bot_platform:latest
...
```bash
# 克隆项目
git clone https://github.com/jyucoeng/tg_bot_platform.git
cd tg_bot_platform

# 编辑 docker-compose.yml，注释 image 行，取消注释 build 行
# image: ghcr.io/jyucoeng/tg_bot_platform:latest  # 注释这行
# build: .                                    # 取消注释这行
...
- **GitHub Issues**: [提交问题](https://github.com/jyucoeng/tg_bot_platform/issues)
