# Telegram 多机器人托管平台(测试中，请去使用v2.0.2的稳定分支)
> 一键部署，轻松管理多个 Telegram 客服机器人

## 🚀 快速部署

### 方式 1：Docker 部署（⭐ 推荐）--docker 暂未测试通过，，请去使用v2.0.2的稳定分支
...
```
文字版教程：
 /start—>点击“我的机器人”—>进入你的机器人名字—>点击验证设置—>可切换简单验证、Cloudflare 验证或人工验证
...
## 机器人平台如何从2.0.1升级到v2.0.2（即增加CF验证）？
